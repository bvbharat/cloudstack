...
public class ClusterResponse extends BaseResponse {
    ...
    @SerializedName("ramovercommitratio") @Param (description = "The ram overcommit ratio of the cluster")
    private String ramovercommitratio;
    ...
    public void setRamovercommitratio (String ramovercommitratio){
